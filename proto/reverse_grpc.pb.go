...
type ReverseServiceClient interface {
	ReverseString(ctx context.Context, in *ReverseRequest, opts ...grpc.CallOption) (*ReverseResponse, error)
}
...
func (c *reverseServiceClient) ReverseString(ctx context.Context, in *ReverseRequest, opts ...grpc.CallOption) (*ReverseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReverseResponse)
	err := c.cc.Invoke(ctx, ReverseService_ReverseString_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReverseServiceServer interface {
	ReverseString(context.Context, *ReverseRequest) (*ReverseResponse, error)
...
func (UnimplementedReverseServiceServer) ReverseString(context.Context, *ReverseRequest) (*ReverseResponse, error) {
