...
const file_proto_reverse_proto_rawDesc = "" +
	"\n" +
	"\x13proto/reverse.proto\x12\areverse\"&\n" +
	"\x0eReverseRequest\x12\x14\n" +
	"\x05input\x18\x01 \x01(\tR\x05input\")\n" +
	"\x0fReverseResponse\x12\x16\n" +
	"\x06output\x18\x01 \x01(\tR\x06output2T\n" +
	"\x0eReverseService\x12B\n" +
	"\rReverseString\x12\x17.reverse.ReverseRequest\x1a\x18.reverse.ReverseResponseB\bZ\x06proto/b\x06proto3"
...
var file_proto_reverse_proto_depIdxs = []int32{
	...
	1, // 1: reverse.ReverseService.ReverseString:output_type -> reverse.ReverseResponse
